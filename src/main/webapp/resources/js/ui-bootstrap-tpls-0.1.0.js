...
angular.module("template/carousel/carousel.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("template/carousel/carousel.html",
    ...
    "    <a ng-click=\"prev()\" class=\"carousel-control left\"><span class='glyphicon glyphicon-chevron-left'></span></a>" +
    "    <a ng-click=\"next()\" class=\"carousel-control right\"><span class='glyphicon glyphicon-chevron-right'></span></a>" +
    "</div>" +
    "");
}]);
